            ...
            <>
              <div className="table-header-group bg-[#C0EBA6] p-2">
                <div className="table-row text-center ">
                  ...
                  <div className="table-cell p-2 text-md">Usia Dominan</div>
                  <div className="lg:table-cell hidden lg:visible p-2">Jumlah Laki-Laki</div>
                  <div className="lg:table-cell hidden lg:visible p-2">Jumlah Perempuan</div>
                  <div className="table-cell p-2 rounded-tr-lg">Total</div>
                </div>
              </div>
            ...
            {diagnosaKeys.map((diagnosa, index) => {
              ...
              return (
                <div className="table-row" key={diagnosa}>
                  ...
                  <div className="table-cell p-2 text-left">{diagnosa}</div>
                  <div className="table-cell p-2 text-center">{info["RATA-RATA USIA"]}</div>
                  <div className="hidden lg:visible lg:table-cell">{info["JUMLAH LAKI-LAKI"]}</div>
                  <div className="hidden lg:visible lg:table-cell">{info["JUMLAH PEREMPUAN"]}</div>
                  <div className="table-cell p-2 text-center">{info["TOTAL JUMLAH"]}</div>
                </div>
              );
            })}
